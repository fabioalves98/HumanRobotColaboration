...
% ADD: Descrição geral deste capítulo das collaborative tasks
...
% ADD: Capacidades deste tipo de task, necessidade de andar sempre a ligar desligar o controlador de velocidade, cuz pesos e merdas
