...
class ArmControl:
    ...
    def __init__(self, robot_ip='10.1.0.2'):
        ...
        try:
            ...
            rospy.logerr("Couldn't connect to gripper xmlrpc proxy")
            rospy.logerr(e)
            # sys.exit(0)
        ...
        try:        
            ...
            if(release_limit < 65.0):
                rospy.logwarn("Gripper release limit might be too low!!")
        except Exception as e:
            rospy.logwarn("Couldn't get gripper release limit")
            # rospy.logerr(e)
            # sys.exit(0)
        ...
        try:
            ...
            rospy.logerr("Couldn't load robot arm or move_group")
            rospy.logerr(e)
            # sys.exit(0)
            return
        rospy.loginfo("Starting robot arm control!")
