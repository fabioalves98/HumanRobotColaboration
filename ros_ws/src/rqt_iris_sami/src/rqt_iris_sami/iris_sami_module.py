...
class IrisSamiPlugin(Plugin):
    ...
    def __init__(self, context):
        ...
        # Give QObjects reasonable names
        self._widget.setObjectName('IrisSamiPluginUI')
    ...
    def rel_move_button_clicked(self):
        print(self._widget.r_x.text())
        print(self._widget.r_y.text())
        print(self._widget.r_z.text())
        print(self._widget.r_roll.text())
        print(self._widget.r_pitch.text())
        print(self._widget.r_yaw.text())
